...
<div class="container my-5">
  ...
  <h1>Presentations</h1>
  <a class="btn btn-outline-primary d-inline-flex align-items-center" href="/createpresentation.aspx"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
</svg></a><br><br>
  </div>     
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
  <?php
            $sql = "SELECT * FROM games WHERE creator_id ='".$_USER['id']."';";
            ...
            if ($resultCheck > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $name = str_replace("{username}",$_USER['name'],$row['name']);
                  ?>
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <a class="btn btn-sm btn-outline-secondary" href="/edit.aspx?id=<?php echo htmlspecialchars($row['id']); ?>&slide=1">Edit</a>
                </div>
