...
if(isset($_POST["submit"])) {
    ...
    //$file_name = base64_encode(htmlspecialchars($_FILES['image']['name']));
    ...
    $sql = "INSERT INTO games (id, name, description, thumbnail, creator_id) VALUES (NULL, '".$gamename."', 'placeholder', 'images/$file_name', '".$_SESSION['id']."')";
     ...
     <div class="container col-xl-10 col-xxl-8 px-4 py-5">
      <div class="col-md-10 mx-auto col-lg-5">
        <form action="" method="post" enctype="multipart/form-data" class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
          <center><h3>CREATE (Work In Progress)</h3></center>
...
<?php echo $footer ?>
  ...
  <div id="EditItemContainer">
    ...
    <div id="ItemName">
      ...
      <input name="name" type="text" value="<?php echo ''.htmlspecialchars($_USER['username']).'';?>'s Place" maxlength="35" class="TextBox">
